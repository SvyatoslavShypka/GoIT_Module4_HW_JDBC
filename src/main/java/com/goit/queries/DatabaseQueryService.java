...
/*
        List<MaxProjectCountClient> listMaxProjectCountClient = DatabaseQueryService.findMaxProjectsClient();
        for (MaxProjectCountClient x: listMaxProjectCountClient
             ) {
            System.out.println(x);
        }
*/
/*
        List<LongestProject> listLongestProject = DatabaseQueryService.findLongestProject();
        for (LongestProject x: listLongestProject
             ) {
            System.out.println(x);
        }
*/
...
/*
        List<MaxSalaryWorker> listMaxSalaryWorker = DatabaseQueryService.findMaxSalaryWorker();
        for (MaxSalaryWorker x: listMaxSalaryWorker
             ) {
            System.out.println(x);
        }
*/
...
/*
        List<YoungestEldestWorkers> result = DatabaseQueryService.findYoungestEldestWorkers();
        for (YoungestEldestWorkers x: result
             ) {
            System.out.println(x);
        }
*/
